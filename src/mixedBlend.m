function [newImg] = mixedBlend(im, mask, new)
            ...
            for x = xLeftMost:xRightMost
                if (mask(y,x)==1)
                    if (x < imw-1)
                        e = e+1;
                        A(e, im2var(y,x)) = -1;
                        b(e) = max(im(y,x+1,dim) - im(y,x,dim), new(y,x+1,dim) - new(y,x,dim));
                        if (mask(y,x+1) == 1)
                            A(e, im2var(y,x+1)) = 1;
                        else
                            A(e, im2var(y,x+1)) = 0;
                            b(e) = b(e) - new(y,x+1,dim);
                        end
                    end
                    if (x > 1)
                        e = e+1;
                    ...
                    if (y < imh-1)
                        e = e+1;
                        A(e, im2var(y,x)) = -1;
                        b(e) = max(im(y+1,x,dim) - im(y,x,dim), new(y+1,x,dim) - new(y,x,dim));
                        if (mask(y+1,x) == 1)
                            A(e, im2var(y+1,x)) = 1;
                        else
                            A(e, im2var(y+1,x)) = 0;
                            b(e) = b(e) - new(y+1,x,dim);
                        end
                    end
                    if (y > 1)
                        e = e+1;
